...
export const scene_D = [
  ...
  { displayName: fool, special: null, background: stars, music: harp_song, soundEffect: null, text: "Where did your accident take place?" },
  { displayName: queen, special: null, background: stars, music: harp_song, soundEffect: null, text: "Can you remember?" },
  { displayName: queen, special: show_answers_vii, background: stars, music: harp_song, soundEffect: null, text: "Such an odd name. Was that really it?" },
  ...
  { displayName: queen, special: show_answers_viii, background: stars, music: harp_song, soundEffect: null, text: "Hmm, I wonder. Are you sure that's right?" },
